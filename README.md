...
ElizaOS v1.7.2
LLM Backend
Qwen3.5 via Ollama (Nosana-hosted)
Frontend
Custom HTML/CSS/JS (black & gold UI, port 4000)
Deployment
...
Load job definition: nos_job_def/agent.json
Set your Docker image:
{
  "image": "alphahunter215/alphahunter-agent:latest"
}
Select a GPU node and deploy
Visit the app URL once the job is running
CLI (alternative)
...
[✅] Custom Frontend Interface (black/gold UI)
[✅] ElizaOS v2 Character Definition
[✅] Deployed on Nosana
